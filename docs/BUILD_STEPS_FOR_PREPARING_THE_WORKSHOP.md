...
3.	Install [AWS CLI 2.17.13](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
    ```bash
    brew install awscli@2
    ```

4.	Install [Packer 1.11.1](https://developer.hashicorp.com/packer/install) for macOS 64-bit.  
    ```bash
    brew tap hashicorp/tap
    brew install hashicorp/tap/packer
    ```

5.	Install [Terraform 1.9.2](https://developer.hashicorp.com/terraform/install) for macOS 64-bit.  
    ```bash
    brew tap hashicorp/tap
...
2.	Install [AWS CLI 2.17.13](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
3.	Install [Packer 1.11.1](https://releases.hashicorp.com/packer/1.11.1/packer_1.11.1_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  

4.	Install [Terraform 1.9.2](https://releases.hashicorp.com/terraform/1.9.2/terraform_1.9.2_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
...
3.	Install [Git 2.45.2](https://git-scm.com/downloads) for Ubuntu 64-bit.  
    ```bash
...
4.	Install [Packer 1.11.1](https://developer.hashicorp.com/packer/install) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    sudo wget https://releases.hashicorp.com/packer/1.11.1/packer_1.11.1_linux_amd64.zip
    sudo unzip packer_1.11.1_linux_amd64.zip
    sudo rm -i packer_1.11.1_linux_amd64.zip
    ```

5.	Install [Terraform 1.9.2](https://developer.hashicorp.com/terraform/install) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.9.2_linux_amd64.zip
    ```
