...
-	Homebrew 4.2.15
-	Git 2.44.0
-	Amazon AWS CLI 2.15.33 (command-line interface)
-	Packer 1.10.2
-	Terraform 1.7.5
-	jq 1.7.1
...
1.	Install the [Homebrew 4.2.15](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
3.	Install [AWS CLI 2.15.33](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
    ```bash
...
5.	Install [Terraform 1.7.5](https://developer.hashicorp.com/terraform/install) for macOS 64-bit.  
    ```bash
    brew tap hashicorp/tap
...
1.	Validate installed command-line tools:
    ...
    aws --version
    # aws-cli/2.15.33 Python/3.11.8 Darwin/23.4.0 source/arm64 prompt/off
...
2.	Install [AWS CLI 2.15.33](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
4.	Install [Terraform 1.7.5](https://releases.hashicorp.com/terraform/1.7.5/terraform_1.7.5_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
...
4.	Validate installed command-line tools:
    ...
    aws --version
    # aws-cli/2.15.33 Python/3.11.6 Windows/10 exe/AMD64 prompt/off
...
5.	Install [Terraform 1.7.5](https://developer.hashicorp.com/terraform/install) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.7.5_linux_amd64.zip
    ```
