...
1.	Install the [Homebrew 4.1.3](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
3.	Install [Git 2.41.0](https://git-scm.com/downloads) for Ubuntu 64-bit.  
    ```bash
    sudo apt install git
    ```

4.	Install [Packer 1.9.2](https://www.packer.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    sudo wget https://releases.hashicorp.com/packer/1.9.2/packer_1.9.2_linux_amd64.zip
    sudo unzip packer_1.9.2_linux_amd64.zip
    sudo rm -i packer_1.9.2_linux_amd64.zip
    ```

5.	Install [Terraform 1.5.4](https://www.terraform.io/downloads.html) for Ubuntu 64-bit.  
    ```bash
    cd /usr/local/bin
    ...
    sudo rm -i terraform_1.5.4_linux_amd64.zip
    ```
