...
-	Homebrew 4.2.15
-	Git 2.44.0
-	Amazon AWS CLI 2.15.32 (command-line interface)
-	Packer 1.10.2
-	Terraform 1.7.5
-	jq 1.7.1
...
3.	Install [AWS CLI 2.15.32](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
    ```bash
...
2.	Install [AWS CLI 2.15.32](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
4.	Validate installed command-line tools:
    ...
    aws --version
    # aws-cli/2.15.32 Python/3.11.6 Windows/10 exe/AMD64 prompt/off
