...
-	Amazon AWS CLI 2.15.20 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.15.20](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.15.20 Python/3.11.7 Darwin/23.3.0 source/arm64 prompt/off
    ```
...
1.	Install [AWS CLI 2.15.20](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
1.	Install [AWS CLI 2.15.20](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
