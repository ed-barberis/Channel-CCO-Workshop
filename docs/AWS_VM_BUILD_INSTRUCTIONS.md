...
-	Amazon AWS CLI 2.13.27 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.13.27](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.13.27 Python/3.11.6 Darwin/23.0.0 source/arm64 prompt/off
    ```
...
1.	Install [AWS CLI 2.13.27](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    aws --version
    # aws-cli/2.13.27 Python/3.11.5 Windows/10 exe/AMD64 prompt/off
    ```

### Windows Subsystem for Linux (WSL) installation - Ubuntu 64-Bit

1.	Install [AWS CLI 2.13.27](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
...
-	Amazon AWS EKS CLI [eksctl] 0.162.0 (command-line interface)
-	Amazon AWS Kubernetes Control CLI [kubectl] 1.27.6 (command-line interface)
-	Ansible 2.9.23
-	Ant 1.10.14
...
-	Go 1.21.3
-	Gradle 8.4
-	Helm CLI 3.13.1 (Package Manager for Kubernetes)
...
-	yq 4.35.2 (command-line YAML processor)
