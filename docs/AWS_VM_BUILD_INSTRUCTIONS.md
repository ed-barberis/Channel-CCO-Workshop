...
2.	Validate installed command-line tools:
    ...
    ```bash
    aws --version
    # aws-cli/2.15.15 Python/3.11.7 Darwin/23.2.0 source/arm64 prompt/off
    ```
...
1.	Install [AWS CLI 2.15.15](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html) for Ubuntu 64-bit.  
    ```bash
    cd /tmp
