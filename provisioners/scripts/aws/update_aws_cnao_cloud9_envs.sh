...
if [ "${aws_account_id}" == "395719258032" ]; then
  ...
  cnao_cloud9_user_share_array+=( "arn:aws:iam::395719258032:user/avinash.rajput" )
  cnao_cloud9_user_share_array+=( "arn:aws:iam::395719258032:user/michael.salami" )
  cnao_cloud9_user_share_array+=( "arn:aws:iam::395719258032:user/sahil.gupta" )
