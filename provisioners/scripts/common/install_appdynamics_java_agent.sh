...
appd_java_agent_release="${appd_java_agent_release:-23.9.0.35116}"
appd_java_agent_sha256="${appd_java_agent_sha256:-d84dd713c45343309fbfbf4041e1457a7d7e3c0c9d618030d0df3235fa5775b9}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.9.0.35116"               # [optional] java agent release (defaults to '23.9.0.35116').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="d84dd713c45343309fbfbf4041e1457a7d7e3c0c9d618030d0df3235fa5775b9"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.9.0.35116/conf/controller-info.xml'
