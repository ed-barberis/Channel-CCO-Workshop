...
appd_java_agent_release="${appd_java_agent_release:-23.10.0.35234}"
appd_java_agent_sha256="${appd_java_agent_sha256:-78f0f23ffac4c5c1862135efcdb38a16d68e89ac0dfe372ca5fdad13e8d9f1ca}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.10.0.35234"              # [optional] java agent release (defaults to '23.10.0.35234').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="78f0f23ffac4c5c1862135efcdb38a16d68e89ac0dfe372ca5fdad13e8d9f1ca"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.10.0.35234/conf/controller-info.xml'
