...
appd_java_agent_release="${appd_java_agent_release:-23.9.1.35149}"
appd_java_agent_sha256="${appd_java_agent_sha256:-715a4b3287cd6b65f9e41a75f45409ad1c7811a8762e56d7b13db26da6a419c8}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.9.1.35149"               # [optional] java agent release (defaults to '23.9.1.35149').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="715a4b3287cd6b65f9e41a75f45409ad1c7811a8762e56d7b13db26da6a419c8"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.9.1.35149/conf/controller-info.xml'
