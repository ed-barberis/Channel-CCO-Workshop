...
appd_java_agent_release="${appd_java_agent_release:-24.3.0.35708}"
appd_java_agent_sha256="${appd_java_agent_sha256:-8f197e79a80a21782e6472512d82ee8af57f86b9bc23283f1e41a1a831d88bd1}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.3.0.35708"               # [optional] java agent release (defaults to '24.3.0.35708').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="8f197e79a80a21782e6472512d82ee8af57f86b9bc23283f1e41a1a831d88bd1"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.3.0.35708/conf/controller-info.xml'
