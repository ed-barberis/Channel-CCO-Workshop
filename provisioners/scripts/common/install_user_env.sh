...
d_completion_release="${d_completion_release:-26.1.0}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="26.1.0"                # [optional] docker completion for bash release (defaults to '26.1.0').
...
user_bashprofile="${devops_home}/provisioners/scripts/common/users/user-bash_profile.sh"
user_bashrc="${devops_home}/provisioners/scripts/common/users/user-bashrc.sh"
