...
d_completion_release="${d_completion_release:-26.0.0}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="26.0.0"                # [optional] docker completion for bash release (defaults to '26.0.0').
