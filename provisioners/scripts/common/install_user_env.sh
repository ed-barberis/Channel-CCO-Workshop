...
d_completion_release="${d_completion_release:-25.0.2}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="25.0.2"                # [optional] docker completion for bash release (defaults to '25.0.2').
