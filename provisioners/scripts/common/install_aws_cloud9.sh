...
case $user_host_os in
  ...
  "AlmaLinux 9.4 (Seafoam Ocelot)"|"Amazon Linux 2023"|"CentOS Stream 9"|"Fedora Linux 37 (Cloud Edition)"|"Fedora Linux 38 (Cloud Edition)"|"Fedora Linux 39 (Cloud Edition)"|"Oracle Linux Server 9.4"|"Rocky Linux 9.4 (Blue Onyx)"|"Ubuntu 20.04.6 LTS"|"Ubuntu 22.04.4 LTS"|"Ubuntu 23.04"|"Ubuntu 23.10")
