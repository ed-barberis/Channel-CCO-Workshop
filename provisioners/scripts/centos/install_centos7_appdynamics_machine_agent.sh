...
appd_machine_agent_release="${appd_machine_agent_release:-23.10.0.3810}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-b382f66ea2b2105bd5ea722f53bb928272eb62b8a340eae20644174f4fdf7a68}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="23.10.0.3810"            # [optional] machine agent release (defaults to '23.10.0.3810').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="b382f66ea2b2105bd5ea722f53bb928272eb62b8a340eae20644174f4fdf7a68"
